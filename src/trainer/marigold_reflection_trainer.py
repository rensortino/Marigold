...
from src.util.logging_util import eval_dict_to_text, tb_logger
...
class MarigoldReflectionTrainer:
    def __init__(
        self,
        cfg: OmegaConf,
        ...
        self.reflection_type = self.cfg.reflection_type
    ...
    def train(self, t_end=None):
        ...
        for epoch in range(self.epoch, self.max_epoch + 1):
            ...
            for batch in skip_first_batches(self.train_loader, self.n_batch_in_epoch):
                ...
                reflection_gt_for_latent = batch[self.reflection_type].to(device)
                ...
                with torch.no_grad():
                    ...
                    # Encode GT depth
                    gt_target_latent = self.encode_reflection(
                        reflection_gt_for_latent
                    )  # [B, 4, h, w]
    ...
    def encode_reflection(self, depth_in):
        # stack depth into 3-channel
        stacked = self.stack_reflection_images(depth_in)
        # encode using VAE encoder
        depth_latent = self.model.encode_rgb(stacked)
        return depth_latent

    @staticmethod
    def stack_reflection_images(depth_in):
