...
from marigold import MarigoldReflectionPipeline
from src.dataset import BaseReflectionDataset, DatasetMode, get_dataset
...
if "__main__" == __name__:
    ...
    parser = argparse.ArgumentParser(
        description="Marigold : Reflection Mask Estimation : Training"
    )
    parser.add_argument(
        "--config",
        type=str,
        default="config/train_marigold_reflection.yaml",
    ...
    # )
    train_dataset: Union[BaseReflectionDataset, List[BaseReflectionDataset]] = (
        get_dataset(
            cfg_data.train,
    ...
    model = MarigoldReflectionPipeline.from_pretrained(
